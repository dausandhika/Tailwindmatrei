...
export const Detail = () => {
  ...
  const ambilProduct = async () => {
    try {
      const response = await axios.get(`https://restaurant-api.dicoding.dev/detail/${id}`); // Perbaikan di sini
        ...
        <div className="w-full max-w-4xl">
          <div className="flex flex-col justify-center items-center">
            ...
            <img
              ...
              src={`https://restaurant-api.dicoding.dev/images/large/${resto.pictureId}`} // Perbaikan di sini
              alt={resto.name}
            />
          </div>
